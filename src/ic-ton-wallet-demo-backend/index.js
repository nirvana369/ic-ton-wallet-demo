...
import { idlFactory } from './ic-ton-wallet-demo-backend.did.js';
export { idlFactory } from './ic-ton-wallet-demo-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IC_TON_WALLET_DEMO_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic-ton-wallet-demo-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic-ton-wallet-demo-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic-ton-wallet-demo-backend.did.js")._SERVICE>}
 */
export const ic_ton_wallet_demo_backend = createActor(canisterId);
